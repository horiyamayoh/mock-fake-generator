...
|---|---|---|---|---|---|---|---|---:|---:|
| negative::BrokenInterface | Interface.h | synthetic-tu | interface-mock | MockBrokenInterface.h |  | no | unsupported items remain: interface_construct, non_public_method | 1 | 7 |
...
| warning | clang | unsupported_interface_construct | interface_construct | Interface.h | negative::BrokenInterface | negative::BrokenInterface::Data | static data member is not part of a pure interface | exclude this member or provide a hand-authored mock |  |  |  |
| warning | clang | unsupported_interface_construct | interface_construct | Interface.h | negative::BrokenInterface | negative::BrokenInterface::Implemented | interface mock mode requires public pure virtual methods | exclude this member or provide a hand-authored mock |  |  |  |
| warning | clang | unsupported_interface_construct | interface_construct | Interface.h | negative::BrokenInterface | negative::BrokenInterface::NonVirtual | interface mock mode requires public pure virtual methods | exclude this member or provide a hand-authored mock |  |  |  |
| warning | clang | unsupported_interface_construct | interface_construct | Interface.h | negative::BrokenInterface | negative::BrokenInterface::StaticCall | static member function is not part of a pure interface | exclude this member or provide a hand-authored mock |  |  |  |
...
| Interface.h | negative::BrokenInterface | negative::BrokenInterface::Data | static data member is not part of a pure interface | exclude this member or provide a hand-authored mock |
| Interface.h | negative::BrokenInterface | negative::BrokenInterface::Implemented | interface mock mode requires public pure virtual methods | exclude this member or provide a hand-authored mock |
| Interface.h | negative::BrokenInterface | negative::BrokenInterface::NonVirtual | interface mock mode requires public pure virtual methods | exclude this member or provide a hand-authored mock |
...
| Interface.h | negative::BrokenInterface | negative::BrokenInterface::StaticCall | static member function is not part of a pure interface | exclude this member or provide a hand-authored mock |
